...
const MainPage = () => {
  return (
    <>
        ...
        <div className="relative w-[80vw] h-[70vh] rounded-3xl mx-auto mt-11 shadow-2xl ">
          <BackgroundVideo />
          ...
          <h1 className="absolute  text-slate-900 bottom-48 left-10  w-[60vw] text-4xl drop-shadow-2xl font-bold tracking-wide lg:text-6xl ">
            Live your dream destinations.
          </h1>
          <p className="absolute text-slate-900 lg:text-3xl lg:font-semibold   text-xl bottom-24  left-10 drop-shadow-2xl tracking-wide">
